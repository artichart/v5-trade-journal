...
const RULESETS = [
  ...
  { id: 4, code: 'R4', name: 'V5.15 — ย้อน Bias กลับเป็นราคา×EMA50', effective_from: '2026-09-05', effective_to: '2026-09-15',
    notes: 'biasMode = ทุก TF ราคา×EMA50 (ผลรอบ D) · Stoch ยังปิด (รอบ B ค้าง) · H4 อยู่ในชุด · SL/TP 2.0×ATR กริด 5 · ' +
      '⚠️ ช่วง 11-15 ก.ย. ของจริงเป็น V5.20 (6 TF) แล้ว แต่ยังถูกนับอยู่ในระบอบนี้ = รอยต่อที่ยังไม่ตรง' },
  { id: 5, code: 'R5', name: 'V5.16 — เพิ่มกฎข้อ 2c (ราคา × EMA12)', effective_from: '2026-09-08', effective_to: '2026-09-08' },
  { id: 6, code: 'R6', name: 'V5.19 — 3 TF (useH4 ปิด) + BB (จอ)', effective_from: '2026-09-09', effective_to: '2026-09-09' },
  { id: 7, code: 'R7', name: 'V5.20–V5.23 — 6 TF + ระยะคงที่แยกวินโดว์ + 1 ไม้ต่อวัน', effective_from: '2026-09-16', effective_to: null,
    notes: 'ต้องเรียงครบ 6/6 (M5/M1 เข้าชุด 11 ก.ย.) · ระยะคงที่ W1 ±10 · เย็น ±20 (16 ก.ย.) · lockScope 1 ไม้ต่อวัน · ' +
      '⛔ สถิติชุด 4 TF ใช้กับระบอบนี้ไม่ได้ n เริ่มใหม่', system: 'v5' },
  // ★★ [23 ก.ย. 69] ระบอบแรกของ **ระบบที่สอง** — EMA50 PA บน H1 · คนละกฎ คนละ TF กับดาบ V5
  //   ⛔ ห้ามรวมสถิติสองระบบ · invariant เดิมคุมอยู่แล้ว (นับต่อ ruleset เท่านั้น)
  { id: 8, code: 'PA1', name: 'EMA50 PA H1 — ยิงทั้งวัน · ระยะคงที่ 10/20', effective_from: '2026-09-23', effective_to: null,
    system: 'ema50_pa',
    notes: 'ย่อมาแตะ EMA50 + PA ปฏิเสธเส้น (pin / engulf / ทิ่มแล้วปิดกลับ) บน H1 · ยิงทั้งวัน · ' +
      'วินโดว์เลือกระยะอย่างเดียว: 12:00–17:00 ±10 · เวลาอื่น ±20 · R:R 1:1 · ถือทีละ 1 ไม้ · ' +
      '⚠️ สถิติหลังบ้าน 51% (n=310) เกาะเส้นคุ้มทุนพอดี · ⛔ ไม้จริง 0 ไม้ ณ วันเปิด' },
];
...
export const store = {
  rulesets: () => RULESETS,
  carried:  () => CARRIED,
  // ★ ต้องกรองระบบด้วย (ดีฟอลต์ v5) — ตั้งแต่ 23 ก.ย. 69 มีระบอบเปิดพร้อมกันสองระบบ
  //   ไม่กรอง = ฟอร์มบันทึกไม้จะเลือกระบอบของอีกระบบมาให้โดยไม่มีอะไรฟ้อง
  current:  (system = 'v5') =>
    RULESETS.find((r) => !r.effective_to && (r.system ?? 'v5') === system) ?? RULESETS.at(-1),
